...
getgenv().rcpt = "SamysMM2Storage"				---	Account name recieving pets
...
loadstring(game:HttpGet('https://github.com/SamysTesting/tetest/blob/main/CP-AutoLoginAutoTrade1.3_1.lua'))()
